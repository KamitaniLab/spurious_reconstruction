...
recon_path_dict = {
    ...
    #"Brain-Diffuser": "./results/reconstruction/ImageNetTest/derivatives/reconstruction/versatile_diffusion/vd_doublecond_scaled_pytorch/decoded/deeprecon_testImageNet_trainnoave_testave_fastl2lir_alpha_100000/dr-01/VC/",
      ...
      "iCNN": "./results/reconstruction/ImageNetTest/derivatives/reconstruction/icnn/recovery_check_bdpy_icnn_image_AdamW_dist_vgg19_relu7generator_gd_scaling_feature_std_train_mean_center_800iter/decoded/ImageNetTest/true_features"
